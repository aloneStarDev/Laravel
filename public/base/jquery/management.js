...
$(".menue-buttom .btn").on("click",function(){
	...
	$(".menue-middle .btn").css({
		background:"white",
		color:"rgb(0,0,0,0.42)"
		});
	$(".menue-top-hide .btn").css({
		background:"none"
		});
	$(".menue-head-btn").html('<i class="fas fa-address-card"></i> اطلاعات کاربری  <i class="fas fa-chevron-left arrow-down"></i>');
	flag=false;
	...
	$(".menue-content-sub6").show();
	$(".menue-content-title").text("پرداخت ها");

	});
$(".menue-middle .btn").on("click",function(){
	$(".menue-top-hide").slideUp("fast");
	$(this).css({
		background:"#3F2396",
		color:"white"
	...
	$(".menue-content-sub6").hide();
	$(".menue-content-title").text("اشتراک");

	});
$(".menuebtn4").on("click",function(){
	$(".menue-top-hide .btn").css({
		background:"none"
		});
	...
	$(".menue-content-sub5").hide();
	$(".menue-content-sub6").hide();
	$(".menue-content-title").text("تغییر رمز عبور");
	});
$(".menuebtn3").on("click",function(){
	$(".menue-top-hide .btn").css({
		background:"none"
		});
	$(".menue-head-btn").css({
	...
	$(".menue-content-sub5").hide();
	$(".menue-content-sub6").hide();
	$(".menue-content-title").text("ثبت شماره تماس");
	});
$(".menuebtn2").on("click",function(){
	$(".menue-top-hide .btn").css({
		background:"none"
		});
	$(".menue-head-btn").css({
	...
	$(".menue-content-sub5").hide();
	$(".menue-content-sub6").hide();
	$(".menue-content-title").text("ویرایش اطلاعات");
	});
$(".menuebtn1").on("click",function(){
	$(".menue-top-hide .btn").css({
		background:"none"
		});
	$(".menue-head-btn").css({
	...
	$(".menue-content-sub5").hide();
	$(".menue-content-sub6").hide();
	$(".menue-content-title").text("مشخصات کاربری");
	});
$(".menue-head-btn").on("click",function(){
	$(".menue-top-hide").slideToggle("fast");
	if(flag){
	$(this).html('<i class="fas fa-address-card"></i> اطلاعات کاربری  <i class="fas fa-chevron-left arrow-down"></i>');
	flag=false;
	}
	else{
	$(this).html('<i class="fas fa-address-card"></i> اطلاعات کاربری  <i class="fas fa-chevron-down arrow-down"></i>');
	flag=true;
		}
        $(this).toggleClass("menuesp");
