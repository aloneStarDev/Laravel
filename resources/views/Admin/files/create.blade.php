        ...
        <form class="form-horizontal" action="{{ route('files.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <input type="number" class="form-control" name="buy" id="buy" step="0.001" max="9999999" placeholder="هزینه ی خرید کامل را  به میلیون وارد کنید" value="{{ old('buy') }}">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <input type="number" class="form-control" name="rahn" id="rahn" step="0.001" max="9999999" placeholder="هزینه ی رهن را  به میلیون وارد کنید" value="{{ old('rahn') }}">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <input type="number" class="form-control" name="ejare" id="ejare" step="0.001" max="9999999" placeholder="هزینه ی اجاره را به میلیون وارد کنید" value="{{ old('ejare') }}">
                </div>
            </div>
            ...
            <div class="form-group req">
                <div class="col-sm-12">
                    ...
                    <select id = "buildingType" name="buildingType" class="bootstrap-select">
                        <option  value="0" selected hidden>نوع ساختمان</option>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <input type="number" class="form-control" name="floor" id="floor" placeholder="طبقه را وارد کنید" value="{{ old('floor') ?? 1 }}">
                </div>
            </div>
