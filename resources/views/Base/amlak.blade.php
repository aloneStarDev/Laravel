...
<div class="placetop">
	<div class="imagediv">
	<img alt="building_photo" src="{{asset("base/images/city_illustrations_empire_state_building_2x.png")}}" class="amlakimage">
	</div>
	<div class="titlediv">
	<h1 style="color: #FFFFFF; font-size:2vw;">عنوان ملک</h1>
	<div class="top-content">
    <p class="right-sub">22004 : کد ملک    </p>
    <p class="left-sub">   98/12/21 :تاریخ درج آگهی</p>
    </div>
	</div>
	</div>
<div class="tri-right">
...
<div class="top-titles-div">
 <div class="top-titles-right">
  ...
  <p class="top-titles-lt">20 میلیون تومان</p>
 </div>
