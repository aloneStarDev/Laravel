 ...
 <div class="pop-content-form2">
  <div class="pop-content-input2">
   ...
   <div style="position: relative; height: 50px;">
    ...
    <input type="number" name="phonenumber" placeholder="شماره تلفن همراه" onkeypress="return event.charCode >= 48 && event.charCode <= 57 && this.value.length < 11" >
    </div>
    <div style="position: relative; height: 50px; margin-top:3%;">
    <i class="fas fa-lock input-lock-repeat"></i>
    <input type="password" name="password-repeat" placeholder="تکرار رمز عبور" maxlength="25" >
    </div>
   </div>
   <div class="input-center">
    <input type="number" name="code" placeholder="کد تایید" onkeypress="return event.charCode >= 48 && event.charCode <= 57 && this.value.length < 11" >
   </div>
  </div>
  <div class="pop-buttons2">
   ...
   <button class="pop-button-left2 btn">
   دریافت کد تأیید
   </button>
  </div>
 </div>
...
<div class="pop-div pop2">
 ...
 <div class="pop-content-form5">
  <div class="pop-content-input5">
   ...
   <input type="number" name="phone" placeholder="شماره تلفن " onkeypress="return event.charCode >= 48 && event.charCode <= 57 && this.value.length < 11" style="width:35%;">
    </div>
  ...
  <div class="melk-content">
   ...
   <textarea type="text" name="explanation" placeholder="توضیحات" maxlength="200" class="textarea-melk2"></textarea>
   </div>
  </div>
 ...
 <div class="pop-content-form6">
  ...
  <div class="melk-content1">
   ...
   <textarea type="text" name="explanation" placeholder="توضیحات" maxlength="200" class="textarea-melk4"></textarea>
   </div>
  </div>
