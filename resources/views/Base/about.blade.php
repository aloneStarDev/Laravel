...
هرروزه از طریق اینترنت به این سیستم وارد میگردند<br>قابلیت تغییر و تصحیح اطلاعات فایل ها ، به صورتی که اگر مالکی تصمیم به تغییر اطلاعات فایل خود از طریق اینترنت داشته<br>
باشد ، به صورت هم زمان به اطلاع آژانس های عضو سایت خواهد رسید<br>اجتناب از فداکردن کیفیت فایل‌ها در برابر کمیت(عدم  ادعای ارائه روزانه صدها فایل تکراری و با آدرس دهی از مسیرهای<br>
